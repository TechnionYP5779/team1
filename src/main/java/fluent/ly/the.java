...
public interface the {
  /** Gives the index(position) of an integer inside of the given list of
   * integers
  ...
  /** Gives the concatenation of an integer and the size of a collection in a
   * new format
   * @param i integer
   ...
   * @return the element one before last in the list given, null if list has
   *         less than 2 members or the list is null */
   ...
   * @return the element previous to the element given, if there is no previous
   *         element, or the list is null, returns null */
  ...
  /** Gives the tail of a list, i.e all elements beginning from the second
   * element
   * @param <T> some type
   * @param ¢ list of said type
  ...
  /** Gives the tail of a string, i.e the string starting from the second
   * character
   * @param ¢ string
  ...
  /** Gives a list with all other elements starting from the first location of
   * an element in a list
   * @param <T> some type
   * @param t element of said type
   * @param ts iterable of said type
   * @return the list of all other elements starting from the first location of
   *         the given element */
   ...
   * @param <T> some type
   * @param ¢ list of said type
   * @return the first element of given type, and null if the list is empty or
   *         null */
   ...
   * @param <T> some type
   * @param ¢ list of said type
   * @return the last element of a given list, and null if the list is empty, or
   *         is null */
   ...
   * @return new iterator that starts from the second element of the given
   *         iterable's iterator */
   ...
   * @param <T> some type
   * @param ¢ list of said type
   * @return first element of given list that contains one element, or null
   *         otherwise. */
   ...
   * @param <T> some type
   * @param ¢ list of said type
   * @return second element of given list or null, if the list has less than 2
   *         elements, or is null */
