...
public interface list {
  /** This class is a representation of a unary operator over a list e.g.: max
   * of a list is a unary operator over a list
   * @author shai
   * @param <T> */
  interface Operator<T> extends UnaryOperator<List<T>> {
    /**/}

  /** This class is a convenient representation of a List of unary list
   * operators. It allows construction via a list of Operators or a copy c'tor.
  ...
  /** This class extends the 'operator list' functionality by allowing it to
   * also create and register basic operators - append and prepend
   * @author shai
   * @param <T> */
  ...
  /** A class extending Operators with extended functionality such as applying
   * and basic operator creation
   * @author shai
   * @param <T> */
  class ToCallExpected<T> extends Operators<T> {
     ...
     *         this operator is 'append' or 'prepend' - two unary functions on a
     *         list. */
     ...
     * @return a new list, which is the combined results of applying all the
     *         operators on xs */
  ...
  /** Creates a new operator list for List<T>, containing only one operator.
   * That operator will add ¢ to the beginning of the list. It is named
   * 'prepend'
   * @param <T>
   * @param ¢ - an element of the list's type.
   * @return - a new operator list of size one */
  ...
  /** @param <T> JD
   * @param ¢ a list
   * @return an operator returning the last item in a list or
   *         <code><b>null</b></code> if the parameter is
