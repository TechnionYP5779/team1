...
public class RectangleTest {
  ...
  @SuppressWarnings({ "static-method", "unused" }) @Test(expected = IllegalArgumentException.class) public void illegalCreationOfPoint()
      throws IllegalArgumentException {
    Pair<Double, Double> p1 = new Pair<Double, Double>(Double.valueOf(1), Double.valueOf(1));
    Rectangle rec = new Rectangle(p1, p1);
  }

  @SuppressWarnings({ "static-method", "unused" }) @Test(expected = IllegalArgumentException.class) public void illegalCreationOfLineX()
      throws IllegalArgumentException {
    Rectangle rec = new Rectangle(new Pair<Double, Double>(Double.valueOf(1), Double.valueOf(1)),
        new Pair<Double, Double>(Double.valueOf(3), Double.valueOf(1)));
  }

  @SuppressWarnings({ "static-method", "unused" }) @Test(expected = IllegalArgumentException.class) public void illegalCreationOfLineY()
      throws IllegalArgumentException {
    Rectangle rec = new Rectangle(new Pair<Double, Double>(Double.valueOf(1), Double.valueOf(1)),
        new Pair<Double, Double>(Double.valueOf(1), Double.valueOf(3)));
  }
